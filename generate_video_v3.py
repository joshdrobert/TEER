...
scenes = [
    ...
    {
        "visual": "workspace_demo.webm", 
        "text": "This is our AI-driven Clinical Decision Support System. Here, you see the real-time hemodynamic analysis of the mitral valve in our web application. Clinicians can interact with this patient-specific 3D model to test different MitraClip placement strategies in silico. Our fluid-structure interaction pipeline instantly predicts the resulting reduction in regurgitation and mechanical stress."
    },
    {
    ...
    {
        "visual": "final_presentation_extracted/ppt/media/image38.png", 
...
def generate_video():
    ...
    for i, scene in enumerate(scenes):
        ...
        if visual_path.endswith('.webm') or visual_path.endswith('.gif') or visual_path.endswith('.mp4'):
    ...
    final_video.write_videofile("Pitch_Demo_Video_v3.mp4", fps=24, preset="ultrafast")
    
    # Cleanup audio
    for i in range(len(scenes)):
        try:
            os.remove(f"scene_{i}.wav")
        except:
            pass
    print("V3 Video generation complete.")
