...
def generate_video():
    ...
    final_video.write_videofile("Pitch_Demo_Video_v6.mp4", fps=24, preset="ultrafast")
    
    for i in range(len(scenes)):
        try:
            os.remove(f"scene_v6_{i}.wav")
        except:
            pass
    print("V6 Video generation complete.")
