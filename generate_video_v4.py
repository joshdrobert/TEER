...
def generate_video():
    ...
    final_video.write_videofile("Pitch_Demo_Video_v4.mp4", fps=24, preset="ultrafast")
    
    # Cleanup audio
    for i in range(len(scenes)):
        try:
            os.remove(f"scene_v4_{i}.wav")
        except:
            pass
    print("V4 Video generation complete.")
